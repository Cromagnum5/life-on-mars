...
9. Replace placeholders while preserving gameplay behavior. **Next.**
...
unit, and falls back to the primitive model if loading fails. Step 9 should
continue replacing placeholder visuals without changing the established
gameplay behavior.
